if [[ "$OSTYPE" == "linux-gnu" ]]; then
    ...
    alias xbox="sudo nice -n -20 mplayer tv:// -tv driver=v4l2:width=1920:height=1080:device=/dev/video4:alsa=1:adevice=hw.5 -fps 59.940 -vo gl -lavdopts lowres=1:fast:skiploopfilter=all -framedrop -nocache"
fi
